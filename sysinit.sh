...
xi "general tools" \
	...
	- lshw rsync earlyoom spt sc-im surfraw android-tools scrcpy translate-shell xautolock miniserve yt-dlp youtube-viewer openntpd bluez lprng qemu lftp fribidi arandr tree bat glow dragon catimg mdp screenkey git-extras xoris \
	-- github-cli glab
