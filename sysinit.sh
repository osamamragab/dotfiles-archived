...
i curl wget ssh gnupg2 pass sxhkd nnn maim xclip xdotool xdg-utils xautolock youtube-dl rsync ripgrep fzf bat xz translate-shell xtools anki zeal tinycron libnotify tig tree unclutter urlscan urlview uftp highlight android-tools calcurse khal pandoc redshift
